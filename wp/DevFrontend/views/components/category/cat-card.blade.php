    ...
    <div class="row" style="margin-bottom: calc(2vw);">
        <div class="col-12 col-lg-6">
            <div class="ratio ratio-1x1 mx-auto" style="max-width: 650px; margin-bottom: calc(1rem + 1vw);">
                <img class="img-fluid shadow-lg rounded-2" src="{{ $data['featured_src'] }}"
                    alt="{{ $data['featured_alt'] }}" fetchpriority="high">
                {{-- tham khao --}}
        ...
        <div class="col-12 col-lg-6">
            <div class="card border-0">
                ...
                <div class="card-body ps-4">
                    <h1 class="fw-bold" style="font-size: calc(1rem + 0.5vw);">{{ strtoupper($data['name']) }} đa sd sad
                        d asd asd sd asd asd sd asd sd</h1>
